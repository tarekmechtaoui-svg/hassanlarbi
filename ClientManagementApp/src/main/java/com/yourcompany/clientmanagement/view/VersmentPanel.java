...
public class VersmentPanel extends JPanel {
    ...
    private void setupButtons() {
        ...
        // Add balance recalculation button for admin purposes
        JButton recalculateButton = createButton("Recalculer Soldes", e -> recalculateAllBalances());
        recalculateButton.setToolTipText("Recalcule tous les soldes restants (fonction administrative)");
        ...
        if (dialog.isConfirmed()) {
            ...
            if (result > 0) {
                ...
                JOptionPane.showMessageDialog(this, 
                    ...
                    "Le solde restant du client a été mis à jour automatiquement.");
            } else {
            ...
            if (dialog.isConfirmed()) {
                ...
                if (versmentController.updateVersment(updatedVersment)) {
                    ...
                    JOptionPane.showMessageDialog(this, 
                        ...
                        "Le solde restant du client a été ajusté automatiquement.");
                } else {
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            ...
            if (versmentController.deleteVersment(versmentId)) {
                ...
                JOptionPane.showMessageDialog(this, 
                    ...
                    "Le solde restant du client a été restauré automatiquement.");
            } else {
    ...
    private void recalculateAllBalances() {
        int confirm = JOptionPane.showConfirmDialog(
                this,
                "Cette opération va recalculer tous les soldes restants.\n" +
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            SwingWorker<Boolean, Void> worker = new SwingWorker<Boolean, Void>() {
                ...
                protected Boolean doInBackground() throws Exception {
                    return versmentController.recalculateAllBalances();
                }
                ...
                protected void done() {
                    try {
                        boolean success = get();
                        if (success) {
                            JOptionPane.showMessageDialog(VersmentPanel.this,
                                "Tous les soldes ont été recalculés avec succès!",
                                "Recalcul terminé",
                                JOptionPane.INFORMATION_MESSAGE);
                            refreshVersmentTable();
                        } else {
                            JOptionPane.showMessageDialog(VersmentPanel.this,
                                "Erreur lors du recalcul des soldes",
                                "Erreur",
                                JOptionPane.ERROR_MESSAGE);
                        }
                    } catch (Exception e) {
                        JOptionPane.showMessageDialog(VersmentPanel.this,
                            "Erreur lors du recalcul: " + e.getMessage(),
                            "Erreur",
                            JOptionPane.ERROR_MESSAGE);
                    }
                }
